...
def get_args():
    ...
    parser.add_argument('-C', '--cert', type=str, help='Set web server certificate file', default=None)
    parser.add_argument('-K', '--key', type=str, help='Set web server key file', default=None)
